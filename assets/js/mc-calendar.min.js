    ...
    var e = {
        422: (e, t, n) => {
          ...
          var a = {
              ...
              date: {
                active: {
                  ...
                  picked: { foreground: "#ffffff", background: "#fff" },
                  today: {
                ...
                inactive: {
                  ...
                  picked: { foreground: "#fff", background: "#fff" },
                  today: {
                    foreground: "rgba(0, 0, 0, 0.2)",
                    background: "rgba(0, 0, 0, 0.2)",
                  },
                },
                marcked: { foreground: "#fff" },
              },
              month_year_preview: {
                active: {
                  default: { foreground: "rgb(0, 0, 0)" },
          ...
          var i = "show-calendar",
            ...
            k = function (e, t) {
              e.dispatchEvent(
                new CustomEvent(f, { bubbles: !0, detail: { direction: t } })
              );
            },
            w = function (e, t) {
              e.dispatchEvent(
                new CustomEvent(h, { bubbles: !0, detail: { direction: t } })
              );
            },
            D = function (e) {
              var t =
          ...
          var E = function (e, t, n) {
            ...
            N = function (e, t) {
              ...
              return {
                display: {
                  ...
                  set setDate(e) {
                    (this.date = e),
                      a.dispatchEvent(new CustomEvent(d, { bubbles: !0 }));
                  },
                },
                header: {
                  target: t,
                ...
                calendar: {
                  ...
                  set setDate(e) {
                    (this.date = e),
                      n.dispatchEvent(new CustomEvent(l, { bubbles: !0 }));
                  },
                },
              };
            },
            A = function (e) {
              ...
              return {
                ...
                close: function () {
                  document
                    .querySelector("#dark-overlay-calendar")
            ...
            P = function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  : 16;
              return parseInt(
                Math.ceil(Math.random() * Date.now()).toPrecision(e)
              ).toString(16);
            };
          function F(e, t) {
            var n = Object.keys(e);
          ...
          var W = function (e) {
              ...
              return {
                isValid: function () {
                  ...
                  return (
                    n ||
                    console.error(
                      new Error('"'.concat(e, '" format is not supported'))
                    )
                  );
                },
            ...
            K = function (e, t) {
              var n = Object.keys(t)
                ...
                .map(function (e) {
                  return new Error(
                    'Data does not match the schema for property: "'.concat(
                      e,
                      '"'
                    )
                  );
            ...
            Z = function (e, t) {
              var n = Object.keys(e)
                ...
                .map(function (e) {
                  return new Error(
                    'Property "'.concat(e, '" is not recognized')
                  );
                });
              e.hasOwnProperty("allowedMonths") &&
                ...
                n.unshift(
                  new Error(
                    '"disableMonths" option cannot be used along with "allowedMonths" option'
                  )
                ),
                ...
                i = function (t) {
                  ...
                  return (
                    ...
                    (function (e, t) {
                      ...
                      (r.push("mc-date--picked"),
                      (t.ariaLabel = "Picked: ".concat(t.ariaLabel))),
                    (function (e, t) {
                      var n = e.options,
                      ...
                      (r.push("mc-date--marked"),
                      (t.ariaLabel = "Marked: ".concat(t.ariaLabel))),
                    (function (e) {
                      var t = e.date;
                      return O(t) === O(new Date());
                    })(t) &&
                      (r.push("mc-date--today"),
                      (t.ariaLabel = "Today: ".concat(t.ariaLabel))),
                    (t.classList = r.join(" ")),
                    t
                  );
                };
                ...
                r.addEventListener(i, function (n) {
                  ...
                  r.addEventListener(p, function (e) {
                    ...
                    if (
                      ((r.pickedDate = c),
                      ye(r),
                      (null === (n = t) || void 0 === n ? void 0 : n._id) ===
                        r._id)
                    ) {
                      var i = t.store;
                      (i.display.setDate = c),
                  ...
                  E.addEventListener("keydown", function (n) {
                    if (
                      ("Enter" == n.key && De(t, e, "keyboard"), "Tab" == n.key)
                    ) {
          ...
          var se = function (e) {
              return {
                ...
                accessibilityMonthYear: e.querySelector(
                  "#mc-picker__month-year"
                ),
            ...
            ge = function (e, t) {
              ...
              l.showCalendarDisplay
                ...
                "year" !== s &&
                  ...
                  "month" !== s &&
                    ((n.innerText = v[u.getDay()]),
                    (a.innerText = u.getDate())));
            },
            be = function (e, t) {
              var n = e.dateCells,
                a = t.store,
              ...
              u = (function (e, t) {
                ...
                return {
                  theme_color: {
                    ...
                    color:
                      (null == t ? void 0 : t.theme_color) || e.theme_color,
                  },
                  main_background: {
                    cssVar: "--mc-main-bg",
                    color:
              ...
              (n.theme = u),
              {
                ...
                reset: function () {
                  (this.pickedDate = null),
                    this.linkedElement && (this.linkedElement.value = null);
                },
                destroy: function () {
                  e.remove(this._id);
                },
                onOpen: function () {
                  $("#dark-overlay-calendar").addClass("active");
                  var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ? arguments[0]
                      : function () {};
                ...
                onClose: function () {
                  console.log($("#dark-overlay-calendar"));
                  $("#dark-overlay-calendar").removeClass("active");
                  var e =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ? arguments[0]
                      : function () {};
                ...
                setFullDate: function (e) {
                  if (!W(e).date())
                    throw new TypeError(
                      "Parameter of setFullDate() is not of type date"
                    );
                ...
                setDate: function (e) {
                  if (!W(e).number())
                    throw new TypeError(
                      "Parameter 'date' of setDate() is not of type number"
                    );
                  var n = this.pickedDate
                    ? new Date(this.pickedDate)
                    : new Date();
                ...
                setMonth: function (e) {
                  if (!W(e).number())
                    throw new TypeError(
                      "Parameter 'month' of setMonth() is not of type number"
                    );
                  var n = this.pickedDate
                    ? new Date(this.pickedDate)
                    : new Date();
                ...
                setYear: function (e) {
                  if (!W(e).number())
                    throw new TypeError(
                      "Parameter 'year' of setYear() is not of type number"
                    );
                  var n = this.pickedDate
                    ? new Date(this.pickedDate)
                    : new Date();
